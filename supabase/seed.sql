...
insert into public.claims (id, initiative_id, type, status, origin, subject, attribute, value, domain, phase, confidence, superseded_by_claim_id, created_by, created_at, updated_at) values
('cccc0001-0000-4000-8000-000000000001','11111111-1111-4111-8111-111111111111','DECISION','ACTIVE','LEGACY','Financing Model','Offered Products','Islamic Financing Only','PRODUCT','Phase 1','HIGH',null,'00000000-0000-4000-8000-000000000001','2026-08-18T10:05:00Z','2026-08-18T10:05:00Z'),
('cccc0001-0000-4000-8000-00000000001b','11111111-1111-4111-8111-111111111111','DECISION','ACTIVE','LEGACY','Repayment Collection','Collection Frequency','Repayment is deducted daily from settlement activity rather than invoiced monthly','FINANCE','Phase 1','HIGH',null,'00000000-0000-4000-8000-000000000001','2026-05-11T00:00:00Z','2026-05-11T00:00:00Z'),
('cccc0001-0000-4000-8000-00000000001c','11111111-1111-4111-8111-111111111111','DECISION','ACTIVE','LEGACY','Disbursement','Phase 1 Approach','Financing is disbursed manually in Phase 1; automation is deferred to a later phase','OPERATIONS','Phase 1','HIGH',null,'00000000-0000-4000-8000-000000000001','2026-08-05T00:00:00Z','2026-08-05T00:00:00Z'),
('cccc0001-0000-4000-8000-000000000003','11111111-1111-4111-8111-111111111111','REQUIREMENT','ACTIVE','LEGACY','Daily Repayment','Calculation Divisor','27','FINANCE','Phase 1','HIGH',null,'00000000-0000-4000-8000-000000000001','2026-06-02T00:00:00Z','2026-06-02T00:00:00Z'),
('cccc0001-0000-4000-8000-000000000004','11111111-1111-4111-8111-111111111111','REQUIREMENT','ACTIVE','LEGACY','Daily Repayment','Calculation Divisor','30','FINANCE','Phase 1','HIGH',null,'00000000-0000-4000-8000-000000000001','2026-08-21T00:00:00Z','2026-08-21T00:00:00Z'),
('cccc0001-0000-4000-8000-000000000005','11111111-1111-4111-8111-111111111111','BUSINESS_RULE','ACTIVE','LEGACY','Repayment Source','Deduction Mechanism','Deducted from merchant settlement activity','FINANCE','Phase 1','HIGH',null,'00000000-0000-4000-8000-000000000001','2026-05-11T00:00:00Z','2026-05-11T00:00:00Z'),
('cccc0001-0000-4000-8000-000000000006','11111111-1111-4111-8111-111111111111','BUSINESS_RULE','ACTIVE','LEGACY','Merchant Eligibility','Minimum Trading History','6 months of continuous settlement activity','PRODUCT','Phase 1','MEDIUM',null,'00000000-0000-4000-8000-000000000001','2026-07-09T00:00:00Z','2026-07-09T00:00:00Z'),
('cccc0001-0000-4000-8000-000000000007','11111111-1111-4111-8111-111111111111','RISK','ACTIVE','LEGACY','Repayment Reconciliation','Exposure','An incorrect divisor would misstate daily repayment across all active contracts','FINANCE','Phase 1','HIGH',null,'00000000-0000-4000-8000-000000000001','2026-09-03T00:00:00Z','2026-09-03T00:00:00Z'),
('cccc0001-0000-4000-8000-000000000008','11111111-1111-4111-8111-111111111111','RISK','UNVERIFIED','LEGACY','Merchant Concentration','Portfolio Exposure','Concentration limits per merchant segment are not stated','RISK','Phase 1','LOW',null,'00000000-0000-4000-8000-000000000001','2026-08-02T00:00:00Z','2026-08-02T00:00:00Z'),
('cccc0001-0000-4000-8000-000000000009','11111111-1111-4111-8111-111111111111','DEPENDENCY','ACTIVE','LEGACY','Settlement Service','Required Capability','Per-merchant daily settlement totals exposed to the finance ledger','TECHNICAL','Phase 1','HIGH',null,'00000000-0000-4000-8000-000000000001','2026-07-30T00:00:00Z','2026-07-30T00:00:00Z'),
('cccc0001-0000-4000-8000-000000000010','11111111-1111-4111-8111-111111111111','DEPENDENCY','DEFERRED','LEGACY','Disbursement Engine','Required Capability','Automated disbursement to merchant accounts','TECHNICAL','Phase 2','MEDIUM',null,'00000000-0000-4000-8000-000000000001','2026-08-05T00:00:00Z','2026-08-05T00:00:00Z'),
('cccc0001-0000-4000-8000-000000000011','11111111-1111-4111-8111-111111111111','ASSUMPTION','UNVERIFIED','LEGACY','Settlement Frequency','Assumed Cadence','Merchants settle on at least 20 days per calendar month','FINANCE','Phase 1','LOW',null,'00000000-0000-4000-8000-000000000001','2026-07-09T00:00:00Z','2026-07-09T00:00:00Z'),
('cccc0001-0000-4000-8000-000000000012','11111111-1111-4111-8111-111111111111','ASSUMPTION','ACTIVE','LEGACY','Contract Term','Default Duration','6 monthly installments','PRODUCT','Phase 1','MEDIUM',null,'00000000-0000-4000-8000-000000000001','2026-07-09T00:00:00Z','2026-07-09T00:00:00Z')
on conflict (id) do nothing;

-- Inserted after the rest so the supersession target already exists.
insert into public.claims (id, initiative_id, type, status, origin, subject, attribute, value, domain, phase, confidence, superseded_by_claim_id, created_by, created_at, updated_at) values
('cccc0001-0000-4000-8000-000000000002','11111111-1111-4111-8111-111111111111','REQUIREMENT','SUPERSEDED','LEGACY','Financing Model','Offered Products','Traditional + Islamic Financing','PRODUCT','Phase 1','HIGH','cccc0001-0000-4000-8000-000000000001','00000000-0000-4000-8000-000000000001','2026-04-18T00:00:00Z','2026-08-18T10:05:00Z')
on conflict (id) do nothing;
